function [freq, chorus_psd] = get_chorus_spectrum
% get_hiss_spectrum
% 
% Get the combined (average) spectrum of evening chorus events
...
% events = [chorus_events; chorus_with_hiss_events];
events = [chorus_with_hiss_events];

events = remove_outside_em_int(events, 'chorus');
...
chorus_psd = freq_cumsum/num_spectra;

%% Plot results
figure;
plot(freq, smooth(10*log10(chorus_psd), 10), 'LineWidth', 2);
grid on;
