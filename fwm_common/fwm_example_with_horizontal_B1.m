...
bkp_file='fwmexample'; % Backup file name
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Optional arguments can be skipped or replaced with []
[EH,nx,ny,EHf]=fwm1(axisymmetric,...
    f,h,perm,eground,...
    ksa,cartesian,nx0,ny0,I0,...
    xkm,ykm,hi,...
...
E=EH(1:3,:,:,:)*impedance0;
B=EH(4:6,:,:,:)*mu0;
Bp=squeeze(sqrt(sum(abs(B(2:3,:,:,:)).^2,1)));
% The Poynting vector
