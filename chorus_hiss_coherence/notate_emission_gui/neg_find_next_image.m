function next_image_str = neg_find_next_image(this_image_str, offset)
% next_image_str = neg_find_next_image(this_image_str, offset)
...
filelist = dir(fullfile(pathstr, '*ss.mat'));
...
if thisfileno + offset > length(filelist) || thisfileno + offset < 1
	error('neg_find_next_image:NoMoreImages', 'No more images in folder');
end
