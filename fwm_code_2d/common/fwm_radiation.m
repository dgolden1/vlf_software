function [ul,dh,uh,dl,Ruh,Rdl,Rul,Rdh]=...
    fwm_radiation(z,nz,F,ground_bc,layers,DEH,uli,dli)
...
%    [ul,dh] = fwm_radiation(z,nz,F,ground_bc,layers,DEH);
% For wave propagation:
%    [ul,dh] = fwm_radiation(z,nz,F,ground_bc,[],[],uli,dli);
...
%    [ul,dh,uh,dl]=fwm_radiation(z,nz,F,ground_bc,layers,DEH);
...
% Input:
%    z (M) - dimensionless altitudes, z=k0*h, k0=w/c, usually with z(1)==0
%       corresponding to the ground; corresponds to the {lower|upper}
%       boundary of layer {k|k-1}
