function [latSun,lonSun] =  sunPosition(year,month,day,hour,minute,second)

%Calculates geographical position of sun at given time
...
tau_sun = -(theta0-RA);  %-- longitude of sun --

latSun = delta;
lonSun = modLon(tau_sun);
