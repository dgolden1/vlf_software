function [sun, h, az] = sunshineC(lat,lon,alt,civil_sun,year,month,day,hour,minute,second)

%At an alititude alt [m], latitutde lat [deg], and longitude lon [deg], at the specified time in UT, calculates
...
[h,az] =  sunAngleC(lat,lon,[year,month,day,hour,minute,second]);
