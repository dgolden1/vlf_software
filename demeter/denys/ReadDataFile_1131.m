%% Reading data from 1131 file
% File: ReadDataFile_1131.m
% -------------------------------------------------------------------------
% Output:
% 
% Efield
...
% initialization
Efield = zeros(FrameNumber1131*nBlockElements1131,1,'single');
...
for iFrame = 1:FrameNumber1131
    ...
    Efield(((iFrame-1)*nBlockElements1131+1):iFrame*nBlockElements1131) =...
...
%% Screen output
disp(['E field has been read from file ',DataFile.name])
