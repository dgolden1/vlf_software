%% Reading data from 1137 (Survey B-field) file
% File: ReadDataFile_1137.m
% -------------------------------------------------------------------------

%initail parameters
%SampleFreq1131 = SampleFreq;

DataFile = dir('DMT_N1_1137_*.DAT'); 
...
%% Screen output
disp(['B power spectrum has been read from file ',DataFile.name])
