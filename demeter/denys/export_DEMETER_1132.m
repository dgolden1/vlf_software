%% Exporting DEMETER VLF 1132 to mat file
% File: export_DEMETER_1132.m
% -------------------------------------------------------------------------
% Output:
%
...
%% Initial parameters
logmin = -3; % just for plotting. Does not affect exporting of data
logmax = 3;
Units = 'log(uV^{2}/m^{2}/Hz)';

%% Exporting
display('BEGINNING OF PROCCESSING===================================================')
ReadDataFile_1132;
save('VLF_E_spectrum_1132.mat',...
'PowerSpectrum','Units','SpectrumSecond','SpectrumFrequency',...
'LatSpline','LongSpline','AltSpline','LThourSpline','LSpline',...  % Note how spline approximation is used below for mapping
'-mat')
display('E-field Power Spectrum is saved to "VLF_E_spectrum_1132.mat"')
...
title(['DEMETER - Onboard spectrogram of E-field component (df = ',...
...
print(fig02, '-zbuffer', '-r300','-dpng',['DEMETER_VLF_E_spectrum_1132_',StartTimeToPrint,'_',StopTimeToPrint,'.png'])
